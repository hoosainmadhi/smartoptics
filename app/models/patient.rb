class Patient < ActiveRecord::Base
  attr_accessible   :city, :medical_aid, :medical_aid_number, :patient_name, :patient_number, :postal_address, :postal_code, :principal_member, :tel_no, :consults_attributes
